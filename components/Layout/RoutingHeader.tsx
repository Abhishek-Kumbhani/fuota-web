...
const Header = ({ isMobile }: { isMobile: boolean }) => {
  ...
  useEffect(() => {
    ...
    !path && router.push("/about");

    setActiveLink(path || "about");
  }, [router]);
          ...
          <ul className="hidden lg:flex col-start-4 col-end-8 text-black-500  items-center">
            <Link
              ...
              className={
                ...
                (activeLink === "about"
                  ? " text-[#0a56d0] animation-active "
                  : " text-black-500 hover:text[#0a56d0] a")
              }
            >
              About
            </Link>
            ...
            <Link
              ...
              className={
                ...
                (activeLink === "feature"
                  ? " text-[#0a56d0] animation-active "
                  : " text-black-500 hover:text-[#0a56d0] ")
              }
            >
              Feature
            </Link>
