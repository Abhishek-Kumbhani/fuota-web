...
import { Facebook, Instagram, FuotaNameLogo, Twitter } from "../../constants/Icons";
function Footer() {
  return (
      ...
      <div className="max-w-screen-xl w-full mx-auto px-6 sm:px-8 lg:px-16 grid grid-rows-4 sm:grid-rows-1 grid-flow-row sm:grid-flow-col grid-cols-3 sm:grid-cols-12 gap-4">
        <div className="row-span-2 sm:col-span-4 col-start-1 col-end-4 sm:col-end-5 flex flex-col items-start ">
          ...
          <p className="mb-4 ml-3">
            <strong className="font-medium">Fuota.IO</strong> is a service that has unique features for users and maintain highest possible security for their data.
          </p>
        ...
        <div className="row-span-2 sm:col-span-2 sm:col-start-11 sm:col-end-13 flex flex-col ml-3 lg:ml-0">
